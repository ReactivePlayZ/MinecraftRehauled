...
public class ModItems {
    ...
    public static final Item BOTTLE_OF_FIRE = registerItem("bottle_of_fire", new Item(new FabricItemSettings()));
    public static final Item BOTTLE_OF_IMPURE_RESIDUE = registerItem("bottle_of_impure_residue", new Item(new FabricItemSettings()));
    public static final Item BUCKET_OF_IMPURE_RESIDUE = registerItem("bucket_of_impure_residue", new Item(new FabricItemSettings()));
